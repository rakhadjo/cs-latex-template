...
\coursetitle{The University of Manchester (something)}
\reportyear{2012}
...
% package & option to set default graphics path
\usepackage{graphicx}
\graphicspath{{media}}

% ... set set default chapters path
...
% sets default path for appendix docs
\makeatletter
\def\input@path{{appendix}}
\makeatother
\include{appendix1}
\end{document}
